...
export function RegisterControlPanelPageRoute() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="bg-card border border-border rounded-xl p-8 max-w-sm w-full text-center">
          ...
          <p className="text-muted-foreground text-sm mb-6">
            Your Control Panel Admin registration is pending approval. You will
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Enter your official employee or authorization ID
              </p>
            </div>
